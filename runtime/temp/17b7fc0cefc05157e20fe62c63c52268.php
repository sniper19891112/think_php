...
jQuery('#qrcode').qrcode({
    ...
    text: "<?php echo htmlentities($url); ?>"
               ...
               value=""></div><div data-v-268420fc="" class="copy" style="display: block;background: linear-gradient(to bottom left,#DB5725FF, #D12D2DFF);" onclick="copy_txt('<?php echo htmlentities($url); ?>')"><?php echo lang('邀请链接:点击复制'); ?></div></div></div></div></body><script>
