<?php /*a:1:{s:69:"F:\xampp\htdocs\think_php\application\index\view\my\top_up_trc20.html";i:1726500651;}*/ ?>
<!DOCTYPE html><html><head><meta charset="utf-8" /><meta name="viewport"
        content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1" /><meta name="apple-mobile-web-app-capable" content="yes" /><meta content="telephone=yes" name="format-detection" /><meta name="apple-mobile-web-app-status-bar-style" content="white" /><meta name="x5-fullscreen" content="true" /><meta name="apple-touch-fullscreen" content="yes" /><title><?php echo lang('我的'); ?></title><link rel="stylesheet" href="/statics/css/global.css" /><link rel="stylesheet" href="/web/css/top_up_trc20.css" /><link rel="stylesheet" href="/static_new/css/public.css"><link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons"><link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons+Outlined"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/qrcodejs/1.0.0/qrcode.min.js"></script></head><body><div id="app"><div class="top-up-header"><i class="material-icons-outlined" style="margin-right: 10px; cursor: pointer;" onclick="goBack()">                arrow_back
                ...
                </div><div id="qrcode" class="qrcode-img"></div><div class="wallet-address">TF1PnfjadjadnajdajhdadknandakhGM</div><div class="text-center"><button class="wallet-address-copy-btn">copy</button></div></div><div class="recharge-container"><div class="text-16 font-800 color-2B2B2B">Recharge amount</div><div class="recharge-amount-input-form"><input class="recharge-amount-input" type="text" placeholder="Please enter the recharge amount!" /></div><div style="margin-top: 24px;" class="text-16 font-800 color-2B2B2B">Top-up certificate</div><div class="d-flex align-center" style="margin-top: 16px;"><div class="certificate-upload" id="uploadArea"><i class="material-icons-outlined certificate-upload-add">                            add
                        </i><input type="file" id="fileInput" style="display: none;" /><div class="file-name" id="fileName"></div></div><div class="uploaded-img"><img id="uploaded_img" src="" style="width: 100%; height: 100%; display: none;" /></div></div></div><div style="margin-top: 24px;"><button class="submit-btn">submit</button></div></div></div></body><script type="application/javascript">    function goBack() {
        window.history.go(-1);
    }
    ...
    $(document).ready(function () {
        ...
        new QRCode(document.getElementById("qrcode"), {
            text: "TF1PnfjadjadnajdajhdadknandakhGM",  // Content for the QR code
