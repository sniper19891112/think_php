...
class Shop extends Controller
{
     ...
     * @return array
     */
    public function submit_goods($shop_name,$en_shop_name,$goods_name,$en_goods_name,$goods_price,$goods_pic,$goods_info,$en_goods_info,$cid,$id='')
    {
        ...
        $data = [
            'shop_name'     => $shop_name,
            'en_shop_name'     => $en_shop_name,
            'goods_name'    => $goods_name,
            'en_goods_name'    => $en_goods_name,
            'goods_price'   => $goods_price,
            'goods_pic'     => $goods_pic,
            'goods_info'    => $goods_info,
            'en_goods_info'    => $en_goods_info,
            'cid'    => $cid,
            'addtime'       => time()
        ];
        if(!$id){
